...
const Banner = () => {
    ...
    <div id="slide1" className="carousel-item relative w-full">
      ...
      <Slide><p className='text-2xl md:text-6xl font-bold'>Get Ready to Feel Your Best</p></Slide>
      <Fade delay={1e3} cascade damping={2e-1}><p className=' md:text-xl font-bold'>Yoga, meditation, and mindful fitness to inspire your wellness goals. Fulfill your soul in this summer camp</p></Fade>
